...
CREATE TABLE PRODUTOS (
    ID_PRODUTO INT NOT NULL AUTO_INCREMENT,
		...
		DT_ATUALIZADO_EM DATETIME NOT NULL,
		ID_ATUALIZADO_POR INT NOT NULL,
    ...
    CONSTRAINT FK_PRODUTOS_USUARIOS_CRIADOR FOREIGN KEY (ID_CRIADO_POR) REFERENCES USUARIOS(ID_USUARIO),
    CONSTRAINT FK_PRODUTOS_USUARIOS_ATUALIZADOR FOREIGN KEY (ID_ATUALIZADO_POR) REFERENCES USUARIOS(ID_USUARIO)
);
